    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xs font-black text-emerald-400 uppercase tracking-[0.4em] lowercase">monthly strategy</h2>
            </div>
            <p className="text-3xl font-black tracking-tight lowercase">aggregate budget control</p>
          </div>

          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-[2rem] min-w-[240px]">
            <div className="flex items-center justify-between mb-1">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest lowercase">total budget limit</span>
              <Calculator className="w-3.5 h-3.5 text-emerald-500" />
            </div>
            <p className="text-3xl font-black text-white">RS {formatCurrency(totalBudget)}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-800 lowercase">category limits</h2>
            <p className="text-sm text-slate-500 font-bold lowercase">set monthly spending caps for your operational expenses.</p>
          </div>
        </div>
            ...
            return (
              <div key={cat.id} className="flex items-center justify-between p-4 rounded-2xl border border-slate-50 hover:border-slate-200 transition-all group bg-white hover:shadow-md hover:shadow-slate-100/50">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-black text-slate-700 text-sm lowercase">{cat.name}</span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <input 
                    ...
                    className="w-24 px-3 py-2 bg-slate-50 border-0 focus:ring-4 focus:ring-emerald-500/10 rounded-xl text-right font-black text-slate-800 text-sm transition-all"
                  />
                </div>
              </div>
            );
        ...
        <div className="mt-10 p-6 bg-emerald-50/50 rounded-3xl border border-emerald-100">
          <div className="flex gap-4">
            ...
            <p className="text-[10px] text-emerald-800 font-bold leading-relaxed lowercase">
